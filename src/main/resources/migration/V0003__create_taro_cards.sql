...
INSERT INTO taro_cards(id, card_number, rus_name, eng_name, image_file_id, symbol, description, features,is_major)
VALUES (1, 0, 'Шут', 'The Fool', 'AgACAgIAAxkBAAIB32V6AbAZqwlCdyOveVroefHkpDYiAAKj1TEbA7PQSwMr692-DtbaAQADAgADcwADMwQ',
        '🤡',
        ...
        'внутренняя свобода, жизнь здесь и сейчас, любопытство, спонтанность',true),
       (2, 1, 'Маг', 'The Magician',
        'AgACAgIAAxkBAAIB4WV6AcXmb1RdZ3dQ8yefNt1ldNQ_AAKv1TEbA7PQS_qxY38D6QlwAQADAgADcwADMwQ',
        '🔮',
        ...
        'самоконтроль, уверенность в себе, креатив, жажда действия, смелости, оригинальности, действие, неформальность, осведомленность, эгоцентризм, высокомерие, самодовольство',true),
       (3, 2, 'Верховная Жрица', 'The High Priestess',
        'AgACAgIAAxkBAAIB42V6AhAX0tLPboqQ0ZY7W0e5H44vAAK51TEbA7PQS_jXK7ztD2d5AQADAgADcwADMwQ', '🧝‍♀️',
        ...
        'готовность принимать решения, забота, новые идеи и задачи, гармония интуиции и разума',true),
       (4, 3, 'Императрица', 'The Empress',
        'AgACAgIAAxkBAAIB5WV6AjS4-2yjN9e-MgKQrwEQ58yUAAK-1TEbA7PQSzxXQoypF2iHAQADAgADcwADMwQ', '👸',
        ...
        'развитие, ответственность за свою жизнь, привязанность к матери, материнство, осознание собственных целей',true),
       (5, 4, 'Император', 'The Emperor',
        'AgACAgIAAxkBAAIB52V6Am2578Ac0_RfRDR8mwGyTnYVAAK_1TEbA7PQS0yTd00W9UjmAQADAgADcwADMwQ', '🤴',
        ...
        'сила, уверенность в себе, стабильность, порядок, самопознание, контроль, воля к победе',true),
       (6, 5, 'Иерофант', 'The Hierophant',
        'AgACAgIAAxkBAAIB6WV6ApVCnZJTUY-bbNrNBCMbQ1PQAALB1TEbA7PQS6VknJndCHoaAQADAgADcwADMwQ', '🛐⛪',
        ...
        'действия по зову сердца и велению души, связь аналитического ума и интуиции, верования, иерархии, союз противоположностей',true),
       (7, 6, 'Влюблённые', 'The Lovers',
        'AgACAgIAAxkBAAIB62V6ArO-7rfT0M2YJ4cEUwan-m0aAALC1TEbA7PQS8gPHpBOyxKqAQADAgADcwADMwQ', '❤️',
        ...
        'Доверие, безопасность, оптимизм, союз противоположностей, тоска по второй половине, проблемы с решением, гармония, совершенство, ложь, обман, болезненные прозрения',true),
       (8, 7, 'Колесница', 'The Chariot',
        'AgACAgIAAxkBAAIB7WV6AsJQ42LGrvMfOCi38SIVfhIGAALD1TEbA7PQS_53svs6J2X2AQADAgADcwADMwQ', '🛴',
        ...
        'прорыв, триумф, движение',true),
       (9, 8, 'Сила', 'Strength', 'AgACAgIAAxkBAAIB72V6AtJy6veX8-fA4RVYuU0-VZr7AALE1TEbA7PQS9jCi_m_8-AZAQADAgADcwADMwQ',
        '💪',
        ...
        'уверенность, решимость, страсть, оптимизм, движущая сила, драма, упадок, шаткость',true),
       (10, 9, 'Отшельник', 'The Hermit',
        'AgACAgIAAxkBAAIB8WV6AuGpspvZ_LLQd0zf31qoA1wNAALF1TEbA7PQS8682DelQZyIAQADAgADcwADMwQ', '🧙‍♂️',
        ...
        'зрелость, мудрость, рассудительность, осознание приоритетов, самоанализ',true),
       (11, 10, 'Колесо Фортуны', 'Wheel of Fortune',
        'AgACAgIAAxkBAAIB82V6AvFiXWIbvsn4mg9ph108KxknAALI1TEbA7PQS5w7DHeXHQAB_wEAAwIAA3MAAzME', '🎡',
        ...
        'предстоящие изменения, активность, возможности, оптимизм, конец определенного периода в жизни, разрешение ситуации, новое начало, паралич, фатализм, нестабильность',true),
       (12, 11, 'Справедливость', 'Justice',
        'AgACAgIAAxkBAAIB9WV6Av9D8AbxZcevVhvfNRHSCleVAALL1TEbA7PQSxYfRxR08vzYAQADAgADcwADMwQ', '⚖️',
        ...
        'осуждение, разрешение сомнений, уравновешенность, беспристрастность, ответственность за свои действия, трансформация, созревание, предубеждение',true),
       (13, 12, 'Повешенный', 'The Hanged Man',
        'AgACAgIAAxkBAAIB92V6AxDOHw0pW6TFWaAlHK9ieXUFAALO1TEbA7PQS84gwPELSWyIAQADAgADcwADMwQ', '🙃',
        ...
        'отказ от неправильного образа жизни, духовная зрелость, духовное пробуждение, разворот, остановка, независимость, застой',true),
       (14, 13, 'Смерть', 'Death',
        'AgACAgIAAxkBAAIB-WV6Ay63IXqfP6_MRjmXVd4GaizwAALU1TEbA7PQS2dUnMikfperAQADAgADcwADMwQ',
        '💀',
        ...
        'конец этапа, отказ от устаревших ценностей и привычек, страх нового начала, необратимость изменения',true),
       (15, 14, 'Умеренность', 'Temperance',
        'AgACAgIAAxkBAAIB-2V6AzvmRR2_buG4-FTXDDlSlKcTAALV1TEbA7PQS1KCmr2yqYAnAQADAgADcwADMwQ', '😐',
        ...
        'равенство противоположных начал, правильный микс, дипломатия, внутренняя сила, ангел-хранитель',true),
       (16, 15, 'Дьявол', 'The Devil',
        'AgACAgIAAxkBAAIB_WV6A1ZyaQ0SLbx3pLNXSCy8howBAALa1TEbA7PQS-FvSm9UB87CAQADAgADcwADMwQ', '😈',
        ...
        'побег из тюрьмы с предрассудками, несвобода из-за иллюзий, осознание ответственности, соблазнение, двуличие, эмоциональная зависимость',true),
       (17, 16, 'Башня', 'The Tower',
        'AgACAgIAAxkBAAIB_2V6A2ewA9NiRyYshJDmlXPjzbDRAALb1TEbA7PQS9KH37_6FiSmAQADAgADcwADMwQ',
        '🗼',
        ...
        'прорыв, освобождение, разрушение',true),
       (18, 17, 'Звезда', 'The Star',
        'AgACAgIAAxkBAAICAWV6A4AOtXMK7WRq36Y3ZJlteF7XAALc1TEbA7PQS8OGIh2DVaU9AQADAgADcwADMwQ',
        '🌟',
        ...
        'творчество, дальновидность, счастье, дух созидания, расслабление, исцеление, душевное здоровье, ненадежность, лихорадочный темп, сомнения',true),
       (19, 18, 'Луна', 'The Moon',
        'AgACAgIAAxkBAAICA2V6A44d_qwLlOSogRP6DML2ZkhXAALd1TEbA7PQSykmB3_ef1lCAQADAgADcwADMwQ',
        '🌚',
        ...
        'желания, подсознание, внутренний голос, ясность, глубина, обман, опасность, страх быть оставленным',true),
       (20, 19, 'Солнце', 'The Sun',
        'AgACAgIAAxkBAAICBWV6A60l4HGzrXsJxmdoUj0IUJbGAALe1TEbA7PQS-MN2P-vPVmGAQADAgADcwADMwQ',
        '🌞',
        ...
        'успех, правда, исцеление, бодрость, возрождение, уверенность в себе, тепло, свободное развитие, утверждение жизни, беспочвенная подозрительность, наивность, отрицание истины',true),
       (21, 20, 'Суд', 'Judgement',
        'AgACAgIAAxkBAAICB2V6A8wThCv6lZI095ZHZh5ba_YyAALf1TEbA7PQS2yWaStdR-fhAQADAgADcwADMwQ',
        '👨‍⚖️',
        ...
        'пробуждение внутреннего голоса, исцеление, освобождение, самообман, непринятие изменений',true),
       (22, 21, 'Мир', 'The World',
        'AgACAgIAAxkBAAICCWV6A9qvuWLtPPMlacebro57G2OKAALg1TEbA7PQSzGY-m4SeL8qAQADAgADcwADMwQ',
        '🌎',
        ...
        'единение с природой и людьми, самопознание, духовная зрелость, совершенство, путешествия, прогресс, определенный успех',true);
INSERT INTO taro_cards(id, card_number, rus_name, eng_name, image_file_id, symbol, description, features)
VALUES
-- Карты Жезлов
    (23, 1, 'Туз Жезлов', 'Ace of Wands️',
        'AgACAgIAAxkBAAICX2V6BhtezD9xVfG9pcEsFzkPJbZ3AAIu1jEbA7PQS-GHVT_8SFsAAQEAAwIAA3MAAzME', '🪄',
       ...
       (24, 2, '2 Жезлов', 'Two of Wands',
        'AgACAgIAAxkBAAICYWV6BiVhOq27EJjvjvgvdFvMrALAAAIw1jEbA7PQS9uLVE_Z8mkxAQADAgADcwADMwQ', '🪄',
       ...
       (25, 3, '3 Жезлов', 'Three of Wands',
        'AgACAgIAAxkBAAICY2V6Biym3I8XBHFrmjWahdi6iIM5AAIx1jEbA7PQSw9JDj251lXxAQADAgADcwADMwQ', '🪄',
       ...
       (26, 4, '4 Жезлов', 'Four of Wands',
        'AgACAgIAAxkBAAICZWV6BjWJM1dYILTjdK2fL-YOb849AAIz1jEbA7PQS729Y8BPlEQIAQADAgADcwADMwQ', '🪄',
       ...
       (27, 5, '5 Жезлов', 'Five of Wands',
        'AgACAgIAAxkBAAICZ2V6BkB_RE-m831URbjYTVbpN2TWAAI01jEbA7PQSx0DzK4JBeVBAQADAgADcwADMwQ', '🪄',
       ...
       (28, 6, '6 Жезлов', 'Six of Wands',
        'AgACAgIAAxkBAAICaWV6Bko7ogpH0EouPj0xxF-4DnnPAAI11jEbA7PQSwYDaVKENytjAQADAgADcwADMwQ', '🪄',
       ...
       (29, 7, '7 Жезлов', 'Seven of Wands',
        'AgACAgIAAxkBAAICa2V6BlPjz3A00_Xb2vZk2dJDkNEZAAI31jEbA7PQS2-wu8WZwUR9AQADAgADcwADMwQ', '🪄',
       ...
       (30, 8, '8 Жезлов', 'Eight of Wands',
        'AgACAgIAAxkBAAICbWV6Bl90HyKvzUGTcDV5FdZPIpVXAAI41jEbA7PQS8CzXpx81CpXAQADAgADcwADMwQ', '🪄',
       ...
       (31, 9, '9 Жезлов', 'Nine of Wands',
        'AgACAgIAAxkBAAICb2V6Bmh_AQYlTcj7vS1d2ES9B7-kAAI61jEbA7PQSx3U-YYW2UrpAQADAgADcwADMwQ', '🪄',
       ...
       (32, 10, '10 Жезлов', 'Ten of Wands',
        'AgACAgIAAxkBAAICcWV6BnMsC5HjnqSJKUqZoasbSY7QAAI71jEbA7PQS3nNQ1WxrGwCAQADAgADcwADMwQ', '🪄',
       ...
       (33, 11, 'Паж Жезлов', 'Page of Wands',
        'AgACAgIAAxkBAAICc2V6Bnt7Zi8fhcnTOJ7NKBufssXxAAI81jEbA7PQS3r_WyhnNCDBAQADAgADcwADMwQ', '🪄',
       ...
       (34, 12, 'Рыцарь Жезлов', 'Knight of Wands',
        'AgACAgIAAxkBAAICdWV6BoVQNsQHnMUP3OYiOmmJFF0NAAI91jEbA7PQS1d1NO77krnIAQADAgADcwADMwQ', '🪄',
       ...
       (35, 13, 'Королева Жезлов', 'Queen of Wands',
        'AgACAgIAAxkBAAICd2V6Bo3v293MCv63eDOxAAGkk7hHiAACPtYxGwOz0EtH9h8YMgTljwEAAwIAA3MAAzME', '🪄',
       ...
       (36, 14, 'Король Жезлов', 'King of Wands',
        'AgACAgIAAxkBAAICeWV6BpXCIJjs-EeUIC0KR-4hYLn1AAI_1jEbA7PQS45a2aNdpvFwAQADAgADcwADMwQ', '🪄',
...
-- Карты Кубков
       (37, 1, 'Туз Кубков', 'Ace of Cups',
        'AgACAgIAAxkBAAICC2V6A_Eihdh5P493SZmr4iAzGF9VAALh1TEbA7PQS8el9LSVPWn2AQADAgADcwADMwQ', '🏆',
       ...
       (38, 2, '2 Кубков', 'Two of Cups',
        'AgACAgIAAxkBAAICDWV6BAj1P_TTP_TiMXNl2aP_TYqrAALi1TEbA7PQS7YIay0yKZKXAQADAgADcwADMwQ', '🏆',
       ...
       (39, 3, '3 Кубков', 'Three of Cups',
        'AgACAgIAAxkBAAICD2V6BBBkd-bO8NapjBP57sMfkZKhAALj1TEbA7PQS-zMwwYv51k8AQADAgADcwADMwQ', '🏆',
       ...
       (40, 4, '4 Кубков', 'Four of Cups',
        'AgACAgIAAxkBAAICEWV6BB-UYROfHngKU5eqrYaw_V2uAALk1TEbA7PQS_z4Mxkki6_VAQADAgADcwADMwQ', '🏆',
       ...
       (41, 5, '5 Кубков', 'Five of Cups',
        'AgACAgIAAxkBAAICE2V6BCmNJo1nZZSgRrOpDe8zlVb5AALp1TEbA7PQSwAB5GCfQv9ELwEAAwIAA3MAAzME', '🏆',
       ...
       (42, 6, '6 Кубков', 'Six of Cups',
        'AgACAgIAAxkBAAICFWV6BDbilTMix7W1AAFouFr5DxnkKQAC9dUxGwOz0EsLzTmcTiqJ7gEAAwIAA3MAAzME', '🏆',
       ...
       (43, 7, '7 Кубков', 'Seven of Cups',
        'AgACAgIAAxkBAAICF2V6BEHXdyUBIhqg1_l8utfuyGPcAAL21TEbA7PQS_9BVQABS2PUlQEAAwIAA3MAAzME', '🏆',
       ...
       (44, 8, '8 Кубков', 'Eight of Cups',
        'AgACAgIAAxkBAAICGWV6BEshlywNt6oJ6UP3_TbJRqV5AAL31TEbA7PQS51SFhWI4bvUAQADAgADcwADMwQ', '🏆',
       ...
       (45, 9, '9 Кубков', 'Nine of Cups',
        'AgACAgIAAxkBAAICG2V6BFS7VndCh3Ia_oDqTbukZKZCAAL41TEbA7PQS2m1Dm39gJCfAQADAgADcwADMwQ', '🏆',
       ...
       (46, 10, '10 Кубков', 'Ten of Cups',
        'AgACAgIAAxkBAAICHWV6BGByRwIWnhOLK1-qggjgCX9uAAL51TEbA7PQS9WQknVB1ZCyAQADAgADcwADMwQ', '🏆',
       ...
       (47, 11, 'Паж Кубков', 'Page of Cups',
        'AgACAgIAAxkBAAICH2V6BG8rH1JfbZIOM_lCtvyn12nMAAPWMRsDs9BLJTI0LNRcapUBAAMCAANzAAMzBA', '🏆',
       ...
       (48, 12, 'Рыцарь Кубков', 'Knight of Cups',
        'AgACAgIAAxkBAAICIWV6BHlLxBZbQjpZYLRFi9uYUqStAAIB1jEbA7PQS_lWZX-OHOaLAQADAgADcwADMwQ', '🏆',
       ...
       (49, 13, 'Королева Кубков', 'Queen of Cups',
        'AgACAgIAAxkBAAICI2V6BImmGVI1_SCktZuOtSIGtpweAAIC1jEbA7PQSzgeqXUvuJWQAQADAgADcwADMwQ', '🏆',
       ...
       (50, 14, 'Король Кубков', 'King of Cups',
        'AgACAgIAAxkBAAICJWV6BJLWL1YNcT1S6hOVGMH-NboWAAID1jEbA7PQS6Az5JqX_SzBAQADAgADcwADMwQ', '🏆',
...
-- Карты Мечей
       (51, 1, 'Туз Мечей', 'Ace of Swords',
        'AgACAgIAAxkBAAICQ2V6BZW4OWnDSEB5JV5OdvBfBQxtAAIa1jEbA7PQS74oUwZJBBH3AQADAgADcwADMwQ', '⚔️',
       ...
       (52, 2, '2 Мечей', 'Two of Swords',
        'AgACAgIAAxkBAAICRWV6BZ2z4A0S6I_DHV7WDUFtDSZFAAIb1jEbA7PQS5N_s-aROJxYAQADAgADcwADMwQ', '⚔️',
       ...
       (53, 3, '3 Мечей', 'Three of Swords',
        'AgACAgIAAxkBAAICR2V6BaRU0J0bAUfB8ld3R8jMvcEFAAId1jEbA7PQS9-dITdMVODgAQADAgADcwADMwQ', '⚔️',
       ...
       (54, 4, '4 Мечей', 'Four of Swords',
        'AgACAgIAAxkBAAICSWV6BayzM0ZPl80AAT2DysuddVfEYwACHtYxGwOz0EseZYaD0PogrQEAAwIAA3MAAzME', '⚔️',
       ...
       (55, 5, '5 Мечей', 'Five of Swords',
        'AgACAgIAAxkBAAICS2V6BbW8As0YgbtzMieGnB3NGgJqAAIf1jEbA7PQS_u2wCVcwukEAQADAgADcwADMwQ', '⚔️',
       ...
       (56, 6, '6 Мечей', 'Six of Swords',
        'AgACAgIAAxkBAAICTWV6Bb37KENpqN3nWsYwm3y8EUZhAAIh1jEbA7PQS7KkcpfCFloMAQADAgADcwADMwQ', '⚔️',
       ...
       (57, 7, '7 Мечей', 'Seven of Swords',
        'AgACAgIAAxkBAAICT2V6BcdxL2zkk0-EYhXq0myxi87PAAIj1jEbA7PQS2SqU6HdrWQMAQADAgADcwADMwQ', '⚔️',
       ...
       (58, 8, '8 Мечей', 'Eight of Swords',
        'AgACAgIAAxkBAAICUWV6BdIqwaLF8CPKNSWcpfNZ_xcAAyXWMRsDs9BLfaNHeQNuddgBAAMCAANzAAMzBA', '⚔️',
       ...
       (59, 9, '9 Мечей', 'Nine of Swords',
        'AgACAgIAAxkBAAICU2V6Bdon15KJ_GBVMQg-bseDmeGDAAIm1jEbA7PQS5wsK37qBr7aAQADAgADcwADMwQ', '⚔️',
       ...
       (60, 10, '10 Мечей', 'Ten of Swords',
        'AgACAgIAAxkBAAICVWV6BeWjY2-2UYeri6QZ8T0GBjMoAAIn1jEbA7PQS_sqO6eUnhzDAQADAgADcwADMwQ', '⚔️',
       ...
       (61, 11, 'Паж Мечей', 'Page of Swords',
        'AgACAgIAAxkBAAICV2V6Be2jh3q5o3lzC_fFGB6iB6JkAAIo1jEbA7PQSywB1l9RBphjAQADAgADcwADMwQ', '⚔️',
       ...
       (62, 12, 'Рыцарь Мечей', 'Knight of Swords',
        'AgACAgIAAxkBAAICWWV6BfanElEe0NLIc9OX2EvakmNpAAIp1jEbA7PQSxAWPKhRSQsCAQADAgADcwADMwQ', '⚔️',
       ...
       (63, 13, 'Королева Мечей', 'Queen of Swords',
        'AgACAgIAAxkBAAICW2V6BgF5giEd-rTZEDpqbxWDdAdUAAIr1jEbA7PQSwsQS4jHca4oAQADAgADcwADMwQ', '⚔️',
       ...
       (64, 14, 'Король Мечей', 'King of Swords',
        'AgACAgIAAxkBAAICXWV6Bgn0pDIRUJq3sFNPw0ubOO0CAAIs1jEbA7PQS4RuiDFKJNkYAQADAgADcwADMwQ', '⚔️',
...
-- Карты Пентаклей
       (65, 1, 'Туз Пентаклей', 'Ace of Pentacles',
        'AgACAgIAAxkBAAICJ2V6BOl8mtCkKAOEnaVG_JXW23weAAIE1jEbA7PQS8BKiUhlzyJ7AQADAgADcwADMwQ', '💰',
       ...
       (66, 2, '2 Пентаклей', 'Two of Pentacles',
        'AgACAgIAAxkBAAICKWV6BPYe1x8wQlXPEqrkQyv7DNW0AAIF1jEbA7PQS0n03jqWFQABegEAAwIAA3MAAzME', '💰',
       ...
       (67, 3, '3 Пентаклей', 'Three of Pentacles',
        'AgACAgIAAxkBAAICK2V6BQEBmE4Z-vftOZ1m1Dcosfx0AAIG1jEbA7PQS5lRgx97C4UKAQADAgADcwADMwQ', '💰',
       ...
       (68, 4, '4 Пентаклей', 'Four of Pentacles',
        'AgACAgIAAxkBAAICLWV6BQtO19pNRM-p9_dpjcZv5y83AAIH1jEbA7PQS7A1PidIQBGKAQADAgADcwADMwQ', '💰',
       ...
       (69, 5, '5 Пентаклей', 'Five of Pentacles',
        'AgACAgIAAxkBAAICL2V6BRiw_s7O-yZfNeyVlVvBGdStAAII1jEbA7PQS5Yv2wbr4UB9AQADAgADcwADMwQ', '💰',
       ...
       (70, 6, '6 Пентаклей', 'Six of Pentacles',
        'AgACAgIAAxkBAAICMWV6BSFJE5aLmH5CNqrb-9K05gipAAIJ1jEbA7PQS4qLv33O-saoAQADAgADcwADMwQ', '💰',
       ...
       (71, 7, '7 Пентаклей', 'Seven of Pentacles',
        'AgACAgIAAxkBAAICM2V6BTrEUszEGQ_41hwMUFTxYx3oAAIK1jEbA7PQS3mC2g1gCTeOAQADAgADcwADMwQ', '💰',
       ...
       (72, 8, '8 Пентаклей', 'Eight of Pentacles',
        'AgACAgIAAxkBAAICNWV6BUMRuTB8HqypK-pgx6UoK0N0AAIL1jEbA7PQS-LT7ZFhBnw7AQADAgADcwADMwQ', '💰',
       ...
       (73, 9, '9 Пентаклей', 'Nine of Pentacles',
        'AgACAgIAAxkBAAICN2V6BUzC9M6NFHJ45epOBolEQjGaAAIM1jEbA7PQS1Ob2_2rR0kWAQADAgADcwADMwQ', '💰',
       ...
       (74, 10, '10 Пентаклей', 'Ten of Pentacles',
        'AgACAgIAAxkBAAICOWV6BVVvs2tXGUOgWlIy1Ldiu_FeAAIN1jEbA7PQS2psSnYI0EfdAQADAgADcwADMwQ', '💰',
       ...
       (75, 11, 'Паж Пентаклей', 'Page of Pentacles',
        'AgACAgIAAxkBAAICO2V6BV86WVzFTULHVqZnokbUZELPAAIO1jEbA7PQSxVb4rFMz4HhAQADAgADcwADMwQ', '💰',
       ...
       (76, 12, 'Рыцарь Пентаклей', 'Knight of Pentacles',
        'AgACAgIAAxkBAAICPWV6BWdNIA-0m40E-7FLbdjBNwTsAAIP1jEbA7PQS1bC7OwaFX3XAQADAgADcwADMwQ', '💰',
       ...
       (77, 13, 'Королева Пентаклей', 'Queen of Pentacles',
        'AgACAgIAAxkBAAICP2V6BXAM-AABxw-Nhf9OerfqyQHCSwACENYxGwOz0EtoXMoE0aTThQEAAwIAA3MAAzME', '💰',
       ...
       (78, 14, 'Король Пентаклей', 'King of Pentacles',
        'AgACAgIAAxkBAAICQWV6BXsIxvWL0dmDd1hDtewwKXNVAAIR1jEbA7PQSzS-ZBkKDv_yAQADAgADcwADMwQ', '💰',
